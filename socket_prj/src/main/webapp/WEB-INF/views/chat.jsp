...
<script	src="https://cdnjs.cloudflare.com/ajax/libs/socket-client/1.4.0/socketjs.js"></script>
<script type="text/javascript">
	var webSocket = {
		...
		receiveMessage : function(msgData) {
			// 정의된 CMD 코드에 따라 분기 처리
			if (msgData.cmd == 'CMD_MSG_SEND') {	// msg 입력
		...
		_initSocket : function() {
			...
			this._socket.onpoen = function (evt) {
				websocket.sendEnter();
			};
...
<body>
	...
	<div style="width: 100%; height: 10%; padding: 10px;">
		<input type="text" id="message" size="110" onkeypress="if(event.keyCode==13){sebSocket.sendChat();}">
